...
echo "Shut game..."
USER_ID="${USER_ID}" GROUP_ID="${GROUP_ID}" GAME_NAME="${GAME_NAME}" GAME_PORT=$GAME_PORT HOURS=$HOURS GAME_OPTIONS=$GAME_OPTIONS docker-compose -f "${COMPOSE_FILE}" down 

echo "-------------------------------------"
echo "Script '${SCRIPT_NAME}'"
echo "Generate map and new game..."
